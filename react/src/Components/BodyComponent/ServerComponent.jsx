...
export default function ServerComponent() {
  ...
  const getAllServersUrl = "http://127.0.0.1:5002/view_server";
  useEffect(() => {
  ...
  return (
    <>
      ...
      <Typography variant="h5" className={classes.serverTitle}>
        Servers
      </Typography>
      ...
      <SelectDiv>
        <SelectIconWrapper>
          <FormControl className={classes.formControl}>
            <InputLabel htmlFor="filled-age-native-simple">Assignee</InputLabel>
            <Select
              native
              //   value={state.age}
              //   onChange={handleChange}
            ...
            >
              ...
              <option value={20}>Infra Admin</option>
      ...
      <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
        ...
        >
          ...
          <Tab label="Pool" {...a11yProps(2)} onClick={poolServData} />
        </Tabs>
      </Box>
                  ...
                  .map((poolServers) => {
                    return (
                      <TableRow
                        ...
                        role="checkbox"
                        tabIndex={-1}
                        key={poolServers.server_id}
                      >
                        {columns.map((column) => {
                          const value = poolServers[column.id];
                          return (
                            <TableCell
                              key={column.id}
                              // align={column.align}
